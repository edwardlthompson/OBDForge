...
- **Quality Gates:** Linters, formatting, full regression test suites, strict file size limits (max 300 lines for static data/UI + i18n, 150 lines for pure logic — `docs/FILE_SIZE_GUIDE.md`), and strict test coverage budgets.
