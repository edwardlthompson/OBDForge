...
fun GoldenPathHomeContent(
    ...
    bluetoothLinkKind: dev.foss.obdforge.domain.transport.BluetoothLinkKind,
    ...
    onBluetoothLinkKindChange: (dev.foss.obdforge.domain.transport.BluetoothLinkKind) -> Unit,
