...
class SessionCsvExporterTest {
    @Test
    fun export_includesSessionDtcAndFreezeRows() {
        val csv = SessionCsvExporter.export(
            SessionDetail(
        ...
        assertTrue(csv.contains("session,vin,1G1JC5442R7251234"))
        assertTrue(csv.contains("dtc,codes,P0133"))
        assertTrue(csv.contains("freeze_frame,pid_0C,1000 rpm"))
    }
}
